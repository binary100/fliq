...
// JOIN TABLES
// movie-tag model
db.movieTags.belongsTo(db.movies, { as: 'movie', foreignKey: 'movie_Id', constraints: false });
db.movieTags.belongsTo(db.tags, { as: 'tag', foreignKey: 'tag_Id', constraints: false });

db.movies.hasMany(db.movieTags, { foreignKey: 'movie_Id', constraints: false });
db.users.hasMany(db.movieTags, { foreignKey: 'tag_Id', constraints: false });
